...
<html>
    <head>
        <title>Remove Items from Dessert Menu</title>
        <link rel="stylesheet" type="text/css" href="css/removeItemStyle.css">
    ...
    <body>
        ...
        <table>
            ...
            {
                echo "
			<form method=\"POST\" action=\"removeFoodProcess.php\">
				<input type=\"text\" name=\"menu\" value=\"dessert\" hidden>
				<tr>
					<td><input type=\"submit\" name=\"submit\" class=\"submit\" value=\"Remove\"></td>
					<td class=\"item\"><input type=\"text\" name=\"item\" class=\"itemName\" value=\"$element\" style=\"border:transparent; width:500px;\"></td>
					<td>$ $price[$count]</td>
				</tr>
			</form>";
                $count++;
        ...
        <a href="AdminUI.php">Go back to Admin Panel</a>
        <footer>
