...
<html>
    ...
    <body>
        ...
        <form method="POST" action="updateDrinksMenu.php">
            <fieldset class="UI-wrapper">
                <legend>Updating Drinks Menu:</legend><br>
                <table class="table-UI">
                    ...
                    <tr>
                        <td><label for="type">Type(Ex: Hot, Alcoholic, etc): </label></td>
                        <td><input type="text" name="type" id="type" required></td>
                    </tr> 
                    <tr>
                        <td><label for="description">Description: </label></td>
                        <td><textarea name="description" id="description" rows="2" cols="20" required></textarea></td>
                    </tr>
                    <tr>
                ...
                <a href="removeDrinks.php">Remove drinks from the Drinks menu</a>
