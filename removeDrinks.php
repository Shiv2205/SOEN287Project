    ...
    <body>
        ...
        <table>
			...
			<form method=\"POST\" action=\"removeFoodProcess.php\">
				<input type=\"text\" name=\"menu\" value=\"drinks\" hidden>
				<tr>
					<td><input type=\"submit\" name=\"submit\" class=\"submit\" value=\"Remove\"></td>
					<td><input type=\"text\" name=\"item\" class=\"itemName\" value=\"$element\" style=\"border:transparent; width:500px;\"></td>
					<td>$ $price[$count]</td>
				</tr>
			</form>";
                $count++;
